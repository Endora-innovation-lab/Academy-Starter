    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-3">
          ...
          <div className="flex justify-center">
            <div className="h-12 w-12 rounded-full flex items-center justify-center" style={{ backgroundColor: 'hsl(180, 60%, 93%)' }}>
              <GraduationCap className="h-6 w-6" style={{ color: 'hsl(180, 60%, 40%)' }} />
            </div>
          </div>
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">🔐 Password: Date of Birth (ddmmyyyy)</p>
            </div>
            <div className="space-y-2">
